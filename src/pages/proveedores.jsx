  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center py-32 text-center flex-1">
        ...
        <h1 className="font-['Sora'] text-[2rem] font-bold text-[#1F1D1A] mb-4">Proveedores</h1>
        <p className="text-[#4A4845] max-w-md">
          Esta sección está en desarrollo. Pronto podrás buscar proveedores por RUT registrados en ChileCompra.
        </p>
      </main>
      <Footer />
    </>
